...
def main():
    ...
    columns = ['speaker', 'prompt', 'utterance']
            ...
            for zip_file in tqdm(zip_file_list):
                with zip_ref.open(zip_file) as zip_data:
                    ...
                    if data:
                        ...
                        raw_data = {key:value for key,value in raw_data.items() if key in columns}
                        raw_data['utterance.transcription'] = raw_data['utterance']['transcription']
                        del raw_data['utterance']
